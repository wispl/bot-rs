...
pub async fn paginate<U: Send + Sync + 'static, E>(
    ...
    while let Some(press) = serenity::collector::ComponentInteractionCollector::new(shard.clone())
        ...
        .await
    {
        ...
        let footer =
            serenity::CreateEmbedFooter::new(format!("page {} out of {length}", current_page + 1));
